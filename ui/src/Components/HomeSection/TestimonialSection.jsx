...
const Slider = () => {
  ...
  return (
    <section className="container-wrap">
      <div>
        ...
        <div className="pb-8">
          ...
          <p className="text-center">
            {" "}
            join a community of satisfied users who have experienced the
            convenience and excellent of our service ... <br /> you're in great
            hand!{" "}
          </p>
        </div>

        <div className="flex space-x-4 justify-center flex-wrap   gap-y-8 md:gap-y-0 ">
      ...
      <div className=" pb-16 pt-24 px-16 w-full grid grid-cols-1  ">
          ...
          <div className="mb-24   max-w-[500px]  rounded-lg  custom-shadow space-x-1  ">
            <section className=" flex-col justify-center ">
              ...
              <div className=" text-center pb-5">
                {" "}
                "Absolutely fantastic! This service has made my bill <br />{" "}
                payments a breeze. Highly recommended!"
              </div>
              <div className=" flex justify-center pb-8">
                {" "}
                <img src={Gstar} className="" />
              </div>
            </section>
          </div>
